...
@sha_init_signature_1 = global i32 0
@sha_init_signature_2 = global i32 0
@sha_update_signature_1 = global i32 0
@sha_update_signature_2 = global i32 0
@llvm.memcpy.p0i8.p0i8.i64_signature_1 = global i32 0
@llvm.memcpy.p0i8.p0i8.i64_signature_2 = global i32 0
@byte_reverse_signature_1 = global i32 0
@byte_reverse_signature_2 = global i32 0
@sha_transform_signature_1 = global i32 0
@sha_transform_signature_2 = global i32 0
@sha_final_signature_1 = global i32 0
@sha_final_signature_2 = global i32 0
@llvm.memset.p0i8.i64_signature_1 = global i32 0
@llvm.memset.p0i8.i64_signature_2 = global i32 0
@sha_stream_signature_1 = global i32 0
@sha_stream_signature_2 = global i32 0
@fread_signature_1 = global i32 0
@fread_signature_2 = global i32 0
@sha_print_signature_1 = global i32 0
@sha_print_signature_2 = global i32 0
...
@fclose_signature_1 = global i32 0
@fclose_signature_2 = global i32 0
...
define void @sha_update(%struct.SHA_INFO*, i8*, i32) #0 {
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 131074, i32 131075)
...
; <label>:18:                                     ; preds = %3
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 131074)
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 131075, i32 0)
  br label %23

; <label>:23:                                     ; preds = %18, %3
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 131075)
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 131076, i32 0)
...
; <label>:38:                                     ; preds = %53, %23
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 131076)
  %39 = load i32, i32* %6, align 4
  %40 = icmp sge i32 %39, 64
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 131077, i32 131081)
  br i1 %40, label %41, label %58

; <label>:41:                                     ; preds = %38
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 131077)
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 131078, i32 0)
  br label %47

; <label>:47:                                     ; preds = %41
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 131078)
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 131079, i32 0)
  br label %51

; <label>:51:                                     ; preds = %47
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 131079)
  %52 = load %struct.SHA_INFO*, %struct.SHA_INFO** %4, align 8
  call void @sha_transform(%struct.SHA_INFO* %52)
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 131080, i32 0)
  br label %53

; <label>:53:                                     ; preds = %51
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 131080)
...
; <label>:58:                                     ; preds = %38
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 131081)
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 131082, i32 0)
  br label %66

; <label>:66:                                     ; preds = %58
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 131082)
  ret void
}
...
; <label>:14:                                     ; preds = %53, %2
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 262147, i32 262149)
...
; <label>:18:                                     ; preds = %14
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 262148, i32 0)
...
; <label>:11:                                     ; preds = %24, %1
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327683, i32 327685)
  br i1 %13, label %14, label %27

; <label>:14:                                     ; preds = %11
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327683)
  %15 = load %struct.SHA_INFO*, %struct.SHA_INFO** %2, align 8
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327684, i32 0)
...
; <label>:24:                                     ; preds = %14
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327684)
...
; <label>:27:                                     ; preds = %11
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327685)
  store i32 16, i32* %3, align 4
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327686, i32 0)
  br label %28

; <label>:28:                                     ; preds = %58, %27
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327686)
  %29 = load i32, i32* %3, align 4
  %30 = icmp slt i32 %29, 80
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327687, i32 327689)
  br i1 %30, label %31, label %61

; <label>:31:                                     ; preds = %28
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327687)
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327688, i32 0)
...
; <label>:58:                                     ; preds = %31
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327688)
...
; <label>:61:                                     ; preds = %28
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327689)
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327690, i32 0)
...
; <label>:82:                                     ; preds = %117, %61
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327690)
  %83 = load i32, i32* %3, align 4
  %84 = icmp slt i32 %83, 20
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327691, i32 327693)
  br i1 %84, label %85, label %120

; <label>:85:                                     ; preds = %82
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327691)
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327692, i32 0)
...
; <label>:117:                                    ; preds = %85
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327692)
...
; <label>:120:                                    ; preds = %82
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327693)
  store i32 20, i32* %3, align 4
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327694, i32 0)
  br label %121

; <label>:121:                                    ; preds = %153, %120
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327694)
  %122 = load i32, i32* %3, align 4
  %123 = icmp slt i32 %122, 40
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327695, i32 327697)
  br i1 %123, label %124, label %156

; <label>:124:                                    ; preds = %121
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327695)
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327696, i32 0)
  %142 = add i64 %137, %141
...
; <label>:153:                                    ; preds = %124
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327696)
...
; <label>:156:                                    ; preds = %121
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327697)
  store i32 40, i32* %3, align 4
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327698, i32 0)
  br label %157

; <label>:157:                                    ; preds = %195, %156
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327698)
  %158 = load i32, i32* %3, align 4
  %159 = icmp slt i32 %158, 60
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327699, i32 327701)
  br i1 %159, label %160, label %198

; <label>:160:                                    ; preds = %157
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327699)
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327700, i32 0)
...
; <label>:195:                                    ; preds = %160
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327700)
...
; <label>:198:                                    ; preds = %157
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327701)
  store i32 60, i32* %3, align 4
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327702, i32 0)
  br label %199

; <label>:199:                                    ; preds = %231, %198
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327702)
  %200 = load i32, i32* %3, align 4
  %201 = icmp slt i32 %200, 80
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327703, i32 327705)
  br i1 %201, label %202, label %234

; <label>:202:                                    ; preds = %199
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327703)
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327704, i32 0)
  %220 = add i64 %215, %219
...
; <label>:231:                                    ; preds = %202
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327704)
...
; <label>:234:                                    ; preds = %199
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 327705)
...
define void @sha_final(%struct.SHA_INFO*) #0 {
  ...
  %13 = lshr i64 %12, 3
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 393218, i32 393222)
  %14 = and i64 %13, 63
...
; <label>:26:                                     ; preds = %1
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 393219, i32 0)
...
; <label>:40:                                     ; preds = %36
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 393221, i32 0)
  br label %42
...
; <label>:60:                                     ; preds = %56
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 393225, i32 0)
  br label %70
...
define void @sha_stream(%struct.SHA_INFO*, %struct._IO_FILE*) #0 {
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 524290, i32 0)
  br label %8
...
; <label>:8:                                      ; preds = %15, %2
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 524291, i32 0)
  br label %12
...
; <label>:12:                                     ; preds = %8
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 524292, i32 524293)
...
define i32 @main(i32, i8**) #0 {
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 720898, i32 0)
...
; <label>:16:                                     ; preds = %15
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 720902, i32 0)
  br label %19
...
; <label>:21:                                     ; preds = %19
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 720904, i32 0)
  br label %23
...
; <label>:23:                                     ; preds = %21
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 720905, i32 0)
...
; <label>:37:                                     ; preds = %23
  ...
  call void @exit_with_remainder_process(i32 720905)
  ret i32 0
}
