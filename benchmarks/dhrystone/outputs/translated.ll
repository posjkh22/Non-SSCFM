...
@strcpy_signature_1 = global i32 0
@strcpy_signature_2 = global i32 0
@Proc_5_signature_1 = global i32 0
@Proc_5_signature_2 = global i32 0
@Proc_4_signature_1 = global i32 0
@Proc_4_signature_2 = global i32 0
@Proc_1_signature_1 = global i32 0
@Proc_1_signature_2 = global i32 0
@Proc_2_signature_1 = global i32 0
@Proc_2_signature_2 = global i32 0
...
@Proc_3_signature_1 = global i32 0
@Proc_3_signature_2 = global i32 0
@Proc_6_signature_1 = global i32 0
@Proc_6_signature_2 = global i32 0
@Func_3_signature_1 = global i32 0
@Func_3_signature_2 = global i32 0
@Proc_7_signature_1 = global i32 0
@Proc_7_signature_2 = global i32 0
@Proc_8_signature_1 = global i32 0
@Proc_8_signature_2 = global i32 0
@Func_1_signature_1 = global i32 0
@Func_1_signature_2 = global i32 0
@Func_2_signature_1 = global i32 0
@Func_2_signature_2 = global i32 0
@strcmp_signature_1 = global i32 0
@strcmp_signature_2 = global i32 0
...
; <label>:51:                                     ; preds = %132, %49
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 65547, i32 65568)
...
; <label>:70:                                     ; preds = %82, %66
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 65553, i32 65555)
...
; <label>:93:                                     ; preds = %115, %92
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 65559, i32 65566)
...
; <label>:104:                                    ; preds = %99
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 65561, i32 65564)
...
; <label>:135:                                    ; preds = %51
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 65569, i32 65570)
...
; <label>:177:                                    ; preds = %163
  ...
  call void @exit_with_remainder_process(i32 65574)
  ret i32 %178
}
...
define i32 @Proc_1(%struct.record*) #0 {
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 458754, i32 0)
...
; <label>:36:                                     ; preds = %14
  ...
  %40 = icmp eq i32 %39, 0
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 458756, i32 458758)
...
; <label>:9:                                      ; preds = %21, %1
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 524291, i32 524292)
...
; <label>:20:                                     ; preds = %13, %9
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 524293, i32 0)
  br label %21
...
; <label>:21:                                     ; preds = %20
  ...
  %23 = icmp ne i32 %22, 0
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 524290, i32 524294)
...
; <label>:10:                                     ; preds = %2
  ...
  %11 = icmp ne i32 %9, 0
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 786436, i32 786435)
...
; <label>:12:                                     ; preds = %10
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 786436, i32 0)
  br label %14
...
; <label>:36:                                     ; preds = %50, %4
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 983043, i32 983045)
...
; <label>:17:                                     ; preds = %2
  ...
  store i32 0, i32* %3, align 4
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 1048580, i32 0)
  br label %20
...
; <label>:20:                                     ; preds = %18, %17
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 1048580)
...
; <label>:8:                                      ; preds = %31, %2
  ...
  %10 = icmp sle i32 %9, 2
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 1114115, i32 1114119)
...
; <label>:26:                                     ; preds = %11
  ...
  %27 = icmp eq i32 %25, 0
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 1114117, i32 1114118)
...
; <label>:28:                                     ; preds = %26
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 1114118, i32 0)
  br label %31
...
; <label>:32:                                     ; preds = %8
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 1114120, i32 1114122)
...
; <label>:36:                                     ; preds = %32
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 1114121, i32 1114122)
  br i1 %39, label %40, label %41

; <label>:40:                                     ; preds = %36
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 1114121)
  store i32 7, i32* %6, align 4
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 1114122, i32 0)
  br label %41
...
; <label>:41:                                     ; preds = %40, %36, %32
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 1114123, i32 1114124)
  br i1 %44, label %45, label %46

; <label>:45:                                     ; preds = %41
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 1114123)
  store i32 1, i32* %3, align 4
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 1114128, i32 0)
  br label %57
...
; <label>:50:                                     ; preds = %46
  ...
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 1114126, i32 1114127)
  br i1 %51, label %52, label %56

; <label>:52:                                     ; preds = %50
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 1114126)
...
; <label>:56:                                     ; preds = %50
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 1114127)
  store i32 0, i32* %3, align 4
  call void @update_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 1114128, i32 0)
  br label %57

; <label>:57:                                     ; preds = %56, %52, %45
  call void @verify_signature(i32* @main_run_signature_1, i32* @main_run_signature_2, i32 1114128)
