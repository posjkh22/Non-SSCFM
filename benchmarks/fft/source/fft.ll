...
; <label>:150:                                    ; preds = %69
  ...
  %171 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i32 0, i32 0))
  %172 = getelementptr inbounds %struct.timeval, %struct.timeval* %14, i32 0, i32 0
  %173 = load i64, i64* %172, align 8
  %174 = getelementptr inbounds %struct.timeval, %struct.timeval* %13, i32 0, i32 0
  %175 = load i64, i64* %174, align 8
  %176 = sub nsw i64 %173, %175
  %177 = mul nsw i64 %176, 1000000
  %178 = getelementptr inbounds %struct.timeval, %struct.timeval* %14, i32 0, i32 1
  %179 = load i64, i64* %178, align 8
  %180 = getelementptr inbounds %struct.timeval, %struct.timeval* %13, i32 0, i32 1
  %181 = load i64, i64* %180, align 8
  %182 = sub nsw i64 %179, %181
  %183 = add nsw i64 %177, %182
  %184 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i32 0, i32 0), i64 %183)
...
; <label>:36:                                     ; preds = %6
  ...
  %39 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %37, i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.5, i32 0, i32 0), i32 %38)
  br label %40
...
; <label>:46:                                     ; preds = %43, %40
  ...
  call void @CheckPointer(i8* %48, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1.6, i32 0, i32 0))
  %49 = load float*, float** %11, align 8
  %50 = bitcast float* %49 to i8*
  call void @CheckPointer(i8* %50, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2.7, i32 0, i32 0))
