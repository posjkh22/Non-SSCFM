...
/* MetaDataSet */
bool MetaDataSet::setEntryFunc(wFunction *wf){
	EntryFunc = wf;
	return true;
}

wFunction *MetaDataSet::getEntryFunc(){
	return EntryFunc;
}

bool MetaDataSet::pushFuncList(wFunction *f){
	wFuncList.push_back(f);
	return true;
}

std::list<wFunction *> *MetaDataSet::getwFuncList(){
	return &wFuncList;
}

wFunction* MetaDataSet::SearchFunction(Function* f){
...
wFunction* MetaDataSet::SearchFunction(const std::string &name){
...
bool MetaDataSet::ShowPathsInEachFunc(){
...
std::list<std::list<wBasicBlock *> *> *MetaDataSet::getGlobalPathsList(){
	return &GlobalPathsList;
}

bool MetaDataSet::ShowTempPathsList(std::list<std::list<wBasicBlock *> *> *PathsList){
...
bool MetaDataSet::insertPath(std::list<std::list<wBasicBlock *> *> **pResult, std::list<wBasicBlock *> *Target, wBasicBlock *CallBB, std::list<std::list<wBasicBlock *> *> *Inserted){
...
std::list<wBasicBlock *>::iterator MetaDataSet::SearchwBlock(std::list<wBasicBlock *> *TargetPath, wBasicBlock *BB){
...
bool MetaDataSet::makeGlobalPathsList(std::list<std::list<wBasicBlock *> *> *insertedPathList){
